...
import 'package:gdds/Screens/Chat/constants/app_constants.dart';
...
import 'package:gdds/Screens/Chat/utils/utils.dart';
...
class HomePageState extends State<HomePage> {
  ...
  void onItemMenuPress(PopupChoices choice) async {
    if ((choice.title == 'Log out') && (buyerLoggedIn = true)) {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      await prefs.clear();
      await handleSignOut();
    } else if (choice.title == 'Log out' && (travelerLoggedIn = true)) {
  ...
  Future<bool> onBackPress() {
    if (buyerLoggedIn = true) {
      Navigator.of(context)
          .push(MaterialPageRoute(builder: (context) => TravelerMain()));
    } else if (travelerLoggedIn = true) {
      Navigator.of(context)
          .push(MaterialPageRoute(builder: (context) => TravelerMain()));
    }
  ...
  //                   ),
  //                   Text(
  //                     'Are you sure to get back to Feeds?',
